...
public class PageUtil {
    ...
    public String createPageTool(String flag) {
        ...
        if (flag.equals(PageUtil.Text)) {
            ...
            str.append("<table width='100%' border='0' cellspacing='0' cellpadding='0' style=\"font-size: 14px;\">");
            str.append("<tr>");
            ...
            if (this.pageCount <= 10) {
                for (int i = 1; i <= this.pageCount; i++) {
                    if (this.currentPage == i) {
                        ...
                        str.append("<a href='javascript:;' style='color:#FFFFFF;background-color:#009688' >" + i + "</a>&nbsp;&nbsp;");
                    } else {
            ...
            str.append("<style>");
            // str
            // .append("BODY {FONT-SIZE: 12px;FONT-FAMILY:宋体;WIDTH: 95%; PADDING-LEFT:
            // 25px;}");
            str.append("DIV.meneame {PADDING-RIGHT: 3px; PADDING-LEFT: 3px; FONT-SIZE: 80%; PADDING-BOTTOM: 3px; MARGIN: 3px; COLOR: #ff6500; " +
                    "PADDING-TOP: 3px; TEXT-ALIGN: center}");
            str.append("DIV.meneame A {BORDER-RIGHT: #ff9600 1px solid; PADDING-RIGHT: 7px; BACKGROUND-POSITION: 50% bottom; BORDER-TOP: #ff9600 " + "1px solid; PADDING-LEFT: 7px; BACKGROUND-IMAGE: url('" + this.request.getContextPath() + "/meneame.jpg'); PADDING-BOTTOM: 5px; " + "BORDER-LEFT: #ff9600 1px solid; COLOR: #ff6500; MARGIN-RIGHT: 3px; PADDING-TOP: 5px; BORDER-BOTTOM: #ff9600 1px solid; " + "TEXT-DECORATION: none}");
            ...
            str.append("DIV.meneame SPAN.current {BORDER-RIGHT: #ff6500 1px solid; PADDING-RIGHT: 7px; BORDER-TOP: #ff6500 1px solid; " + "PADDING" +
                    "-LEFT:" + " 7px; FONT-WEIGHT: bold; PADDING-BOTTOM: 5px; BORDER-LEFT: #ff6500 1px solid; COLOR: #ff6500; MARGIN-RIGHT: " +
                    "3px; PADDING-TOP: " + "5px; BORDER-BOTTOM: #ff6500 1px solid; BACKGROUND-COLOR: #ffbe94}");
            str.append("DIV.meneame SPAN.disabled {BORDER-RIGHT: #ffe3c6 1px solid; PADDING-RIGHT: 7px; BORDER-TOP: #ffe3c6 1px solid; " + "PADDING"
                    + "-LEFT: 7px; PADDING-BOTTOM: 5px; BORDER-LEFT: #ffe3c6 1px solid; COLOR: #ffe3c6; MARGIN-RIGHT: 3px; PADDING-TOP: 5px; " +
